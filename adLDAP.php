...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "dc=coep,dc=org,dc=in";
    ...
    * @var string
    */
	protected $baseDn = "dc=coep,dc=org,dc=in"; 
    ...
    * @var array
    */
    protected $domainControllers = array("10.1.101.41");
    ...
    * @return bool
    */
    public function searchDn($username) {
        $set =  ldap_search($this->ldapConnection, $this->baseDn, "(cn=" . $username . ")");
        if(!$set) {
            return false;
        }
	$entries = ldap_get_entries($this->ldapConnection, $set);
	if($entries['count'] != 0) {
		$entry = $entries[0];
	    return $entry;
    }
